      ...
      <div class="layout-container flex h-full grow flex-col">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf4] px-10 py-3">
          <div class="flex items-center gap-4 text-[#0d141c]">
            ...
            <h2 class="text-[#0d141c] text-lg font-bold leading-tight tracking-[-0.015em]">Book Haven</h2>
          </div>
          <div class="flex flex-1 justify-end gap-8">
            <div class="flex items-center gap-9">
              <a class="text-[#0d141c] text-sm font-medium leading-normal" href="#">Books</a>
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">The Secret Garden</p>
              ...
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">Pride and Prejudice</p>
              ...
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">To Kill a Mockingbird</p>
              ...
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">1984</p>
              ...
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">The Great Gatsby</p>
              ...
              <div class="flex flex-col gap-3 pb-3">
                ...
                ></div>
                <div>
                  <p class="text-[#0d141c] text-base font-medium leading-normal">Moby Dick</p>
        ...
        <footer class="flex justify-center">
          <div class="flex max-w-[960px] flex-1 flex-col">
            <footer class="flex flex-col gap-6 px-5 py-10 text-center @container">
              ...
              <p class="text-[#49739c] text-base font-normal leading-normal">@2024 Book Haven. All rights reserved.</p>
            </footer>
          </div>
        </footer>
      </div>
