<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CRUDOnboarding.WebForm1" %>
...
<head runat="server">
    ...
    <link rel="icon" type="image/x-icon" href="data:image/x-icon;lg64," />

    <script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
</head>
<body>
    <div class="relative flex size-full min-h-screen flex-col bg-slate-50 group/design-root overflow-x-hidden" style='font-family: Newsreader, "Noto Sans", sans-serif;'>
        <div class="layout-container flex h-full grow flex-col">
            <header class="whitespace-nowrap border-b border-solid border-b-[#e7edf4] px-10 py-4">
                <div class="max-w-7xl flex items-center justify-between whitespace-nowrap m-auto ">
                    <div class="flex items-center gap-1 text-[#0d141c]">
                        <div class="size-6">
                            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4 4H17.3334V17.3334H30.6666V30.6666H44V44H4V4Z" fill="currentColor"></path></svg>
                        </div>
                        <h2 class="text-[#0d141c] pt-2.5 text-xl font-bold leading-tight tracking-[-0.015em]">Book Haven</h2>
                    </div>
                    <div class="flex flex-1 justify-end gap-8">
                        <div class="flex items-center gap-9">
                            <a class="text-[#0d141c] text-lg font-medium leading-normal" href="#">Books</a>
                            <a class="text-[#0d141c] text-lg font-medium leading-normal" href="#">Categories</a>
                            <a class="text-[#0d141c] text-lg font-medium leading-normal" href="#">About Us</a>
                            <a class="text-[#0d141c] text-lg font-medium leading-normal" href="#">Contact</a>
                        </div>
                ...
                <div class="flex max-w-[960px] flex-1 flex-col">
                    <footer class="flex flex-col gap-6 px-5 py-10 text-center @container">
                        <div class="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
                            <a class="text-[#49739c] text-lg font-normal leading-normal min-w-40" href="#">Terms of Service</a>
                            <a class="text-[#49739c] text-lg font-normal leading-normal min-w-40" href="#">Privacy Policy</a>
                            <a class="text-[#49739c] text-lg font-normal leading-normal min-w-40" href="#">Contact Us</a>
                        </div>
                        ...
                        <p class="text-[#49739c] text-lg font-normal leading-normal">@2024 Book Haven. All rights reserved.</p>
                    </footer>
                </div>
            </footer>
        </div>
